...
import { SCHEDULE } from '../enums/menu.enum';
...
export default () => (
  <div className="container-fluid">
    ...
    <div className="container-fluid">
      ...
      <label>
        <b>Monday - Saturday Daily Schedule</b>
      </label>
      <br />
      <table>
        <tr>
      ...
      <br />
      <label>
        <b>Sunday Evening Special Schedule</b>
      </label>
      <br />
      <table>
        <tr>
      ...
      <br />
      <p className="iskcon-label">
        Please Note: Subject to change to accomodate events and circumstances.
        Please call ahead if you need to confirm the schedule for a specific
        day/time.
      </p>
    </div>
  </div>
