...
export default () => (
  <div className="container-fluid">
    ...
    <div className="container">
      ...
      <br />
      <h5 className="iskcon-donate"> Donate By Check</h5>
      <br />
      ...
      <br />
      In the memo section of the check, please specify the purpose of your
      donation and your contact number. You can also drop your check in the
