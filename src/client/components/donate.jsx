...
export default () =>
  <div className="container-fluid">
    ...
    <div className="container">
      <h2 className="iskcon-contribute">CONTRIBUTE</h2><br />
      <h5 className="iskcon-donate"> Donate By Check</h5><br />
      ...
      <br />
      In the memo section of the check, please specify the purpose of your donation and your contact number.
      You can also drop your check in the temple donation box located in front of the Jagannath Deities at any time. We will mail you a receipt after confirming your address.<br />
      <br />
