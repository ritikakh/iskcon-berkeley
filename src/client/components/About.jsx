...
export default () =>
  <div class="container">
    ...
    <div className="container-fluid">
      ...
      <h4 className="iskcon-h3">Location and Contact Information</h4>
      <b>Address:</b>&nbsp; 2334 Stuart Street, Berkeley, CA 94705, USA<br/>
      <b>Phone:</b>&nbsp; +1-650- 713-1812<br/>
      <b>Email:</b>&nbsp; iskconbayarea@gmail.com<br/>
      <b>Parking information:</b>&nbsp; There are 12 parking spots on the temple property. Street parking is also
        available. On festival days, you may have to park in nearby commercial garages.<br/><br/>
